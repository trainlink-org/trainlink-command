...
<template>
    ...
    >
        ...
        <div
            class="z-20 h-6 w-32 cursor-pointer select-none rounded-t rounded-b-none border border-solid border-slate-800 text-white"
        ...
        >
            <div class="mx-auto w-fit border border-transparent border-b-black px-1 text-center">
                {{ selectedComputed }}
                <span class="absolute top-2.5 ml-2 h-0 w-0 border-4 border-solid border-transparent border-x-transparent border-t-black border-b-transparent"/>
            </div>
        </div>
        <div
            v-show="open"
