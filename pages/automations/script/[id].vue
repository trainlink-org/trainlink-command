        ...
        <div class="h-1/3">
            <div class="flex flex-col border-b-2 border-primary-300 bg-primary-100 px-1">
                <div class="flex w-full text-lg">
                    ...
                    <span class="text-md w-1/6 text-right text-primary-600">#{{ script.id }}</span>
                </div>
            ...
            <div v-if="editDescription" class="flex h-full flex-col rounded-lg px-1 pt-1">
                ...
                <div class="flex flex-row justify-end space-x-1 pt-1">
                    ...
                    <button class="rounded border-2 border-accent-400 bg-accent-400 px-1 hover:bg-accent-300" @click="
                        editDescription = false;
