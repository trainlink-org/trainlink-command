...
import { AutomationType, type RunningAutomationClient, AutomationStatus } from 'coursework-lib';
...
<template>
    <div class="flex h-full w-full items-center justify-evenly pt-10">
        ...
        >
            ...
            <ul>
                <li
                    v-for="automation in Array.from(runningAutomations.values())"
                ...
                >
                    ...
                    >
                        ...
                        <div class="flex h-full w-full items-center justify-end">
                            <!-- Pause Icon -->
                            <svg
                                v-if="automation.status === AutomationStatus.Running"
                            ...
                            <!-- Play Icon -->
                            <svg
                                v-if="automation.status === AutomationStatus.Paused"
                                xmlns="http://www.w3.org/2000/svg"
                                width="32"
                                height="32"
                                fill="currentColor"
                            ...
                            <svg
                                ...
                                viewBox="0 0 16 16"
                                @click="socket.emit('automation/stopAutomation', automation.pid)"
                            >
            ...
            <ul>
                <li
                    v-for="script of Array.from(automationList.values()).filter((value) => {return value.type !== AutomationType.Sequence;})"
                    :key="script.id"
    ...
    >
        <SelectComponent
            v-model:selected="allocateLocoSelect"
