        ...
        <div v-if="!detailsOpen || !smallScreen"
            ...
            <div v-if="fileUploadOpen" class="flex flex-col border-b-4 border-b-primary-300 bg-primary-100 pl-2 pr-3">
                ...
                <div class="mb-1 flex justify-end space-x-1 justify-self-end">
                    <button class="rounded border-2 border-primary-400 px-1 hover:bg-accent-100" @click="
            ...
            <ul>
                <li v-for="script of Array.from(automationList.values()).filter(
                    (value) => {
                    ...
                    <div class="group grid w-full grid-flow-row auto-rows-min grid-cols-5" @click="
                        router.push('/automations');
