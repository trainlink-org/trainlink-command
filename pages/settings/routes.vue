...
import { TurnoutState, type Coordinate, type Destination, type Turnout } from 'coursework-lib';
    ...
    <div class="flex h-full w-full flex-col">
        ...
        >
            ...
            <TurnoutComponent
                ...
                @mousedown="(event) => lineEditMode ? createLine(turnout.id) : drag(turnout.id, event)"
                @mouseup="(event) => {if(!lineEditMode) drop()}"
            />
            <DestinationComponent
                ...
                @mousedown="(event) => drag(destination.id, event)"
                @mouseup="drop"
            />
            <ConnectorHandleComponent
                ...
                @mousedown="(event) => dragPoint(point.id, event)"
                @mouseup="dropPoint"
            />
