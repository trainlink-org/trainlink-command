...
<template>
    <div class="flex h-full w-full flex-col justify-between">
            ...
            <ul>
                ...
                >
                    ...
                    >
                        ...
                        <p
                            class="col-span-1 row-span-2 flex flex-row space-x-3 self-center justify-self-end"
                        >
        ...
        <!-- Bottom bar -->
        <div
            class="flex w-full items-center justify-around border-t-2 border-primary-300 py-1"
        >
            <!-- Back Icon -->
            <button
        ...
        >
            ...
            <div class="col-span-2">
                <input
                    ...
                    :class="
                        addError.name ? 'border-red-600' : 'border-primary-400'
                    "
                />
                <p
